...
class QuestionAnswer(models.Model):
    ...
    question = models.ForeignKey('exams.Question', on_delete=models.CASCADE, verbose_name='вопрос')
...
class Question(models.Model):
    ...
    answers = models.ManyToManyField(Answer, through=QuestionAnswer, related_name='questions', verbose_name='ответы')
...
class ExamQuestion(models.Model):
    ...
    test = models.ForeignKey('exams.Exam', on_delete=models.CASCADE, verbose_name='тест')
    question = models.ForeignKey('exams.Question', on_delete=models.CASCADE, verbose_name='вопрос')
...
class Exam(models.Model):
    ...
    questions = models.ManyToManyField(Question, through=ExamQuestion, related_name='exams', verbose_name='тесты')
